...
import { alter } from "./ArrayValues";
    ...
    export const Update=(connect)=>
    {
        ...
        const[person,setPerson]=useState({
            "stuName":connect.mention.stuName,
            "stuDob":connect.mention.stuDob,
            "stuAdd":connect.mention.stuAdd,
            "stuEmail":connect.mention.stuEmail,
            "stuNum":connect.mention.stuNum,
            "stuCourse":connect.mention.stuCourse,
            "stuPayment":connect.mention.stuPayment,
            "stuSkills":connect.mention.stuSkills
        })
        const tracky=(hey)=>
    {
